 ...
 */
 //返回顶部
(function() {
	var zx_go_top = $('<div class="zx_go_top"></div>').appendTo($("body")).click(function() {
		$("html, body").animate({ scrollTop: 0 }, 120);
	});
	var zx_go_top_show = function(){
		var st = $(document).scrollTop(), winh = $(window).height();
		(st > 300)? zx_go_top.show(): zx_go_top.hide(); 
	}
	$(window).bind("scroll", zx_go_top_show);
})(); 