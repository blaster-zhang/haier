<div class="usercenter-box">
  ...
  <div class="usercenter-right">
  	 ...
  	 <div class="my-newstory">
     	 <div class="my-new-left">
          <div class="bbs-tiltle">
         	<h4  class="my-bbs-h">论坛</h4>
            <ul class="bbs-title-btn">
            	<li><a href="#"  class="fans-huia">我的发帖</a></li>
                <li><a href="<?php echo Yii::app()->createUrl("/mypage/reply"); ?>">我的回帖</a></li>
                <div class="clear"></div>
            </ul>
            <form>
            	<input  class="up-img" type="button"   />
            </form>
            <div class="clear"></div>
           </div> 
